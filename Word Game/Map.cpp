...
Monster* Map::checkRandomEncounter()
{
	...
	{
		monster = new Monster("Orc", 10, 8, 10, 200, 1,
			"Short Sword", 2, 7);
	...
	{
		monster = new Monster("Goblin", 6, 6, 6, 100, 0,
			"Dagger", 1, 5);
	...
	{
		monster = new Monster("Ogre", 20, 12, 20, 500, 2,
			"Club", 3, 8);
	...
	{
		monster = new Monster("Orc Lord", 25, 15, 200, 2000, 5,
